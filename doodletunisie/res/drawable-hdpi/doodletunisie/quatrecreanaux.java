...
public class quatrecreanaux extends Activity {
	private static final String TAG_TITRE = "titre";
	@Override
	protected void onCreate(Bundle savedInstanceState) {
		super.onCreate(savedInstanceState);
		setContentView(R.layout.quatrecreanaux);
...
//	        tttt
	        ...
	        final EditText debu4 = (EditText) findViewById(R.id.editText7);
	        final EditText fin4 = (EditText) findViewById(R.id.editText8);
	        
	        Button crenauButton = (Button) findViewById(R.id.button3);
	        Intent ine = getIntent();
	       final  String title = ine.getStringExtra(TAG_TITRE);
	       Toast.makeText(quatrecreanaux.this, title, 
	        ...
	        crenauButton.setOnClickListener(new OnClickListener() {
				...
				public void onClick(View v) {
			        ...
			        String deb4=debu4.getText().toString();
			        String fi4=fin4.getText().toString();
			        ...
			        //String titr=titre.getText().toString();
		             ...
		             try {
		            	 ...
		            	 jsonarray.put(json3);
		            	    ...
		            	    Toast.makeText(quatrecreanaux.this, jsonarray.toString() + "\n",
		    						Toast.LENGTH_SHORT).show();
		                    ...
		                    Toast.makeText(quatrecreanaux.this, response.getStatusLine().getStatusCode() + "\n",
		    						Toast.LENGTH_SHORT).show();
		             ...
		             Toast.makeText(quatrecreanaux.this, not + " ajout crenaux successful ! " + "\n",
	 						Toast.LENGTH_SHORT).show();
