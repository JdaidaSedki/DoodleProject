...
public class authentification extends Activity implements OnClickListener  {
    ...
    public  boolean checkInternetConnection() {
		...
		if (conMgr.getActiveNetworkInfo() != null
			...
			Toast.makeText(this, "Internet Connection  Present", 50000).show();
	...
	private class LongRunningGetIO extends AsyncTask <Void, Void, String> {
		private ProgressDialog dialog = 
	            new ProgressDialog(authentification.this);
       ...
       text = getASCIIContentFromEntity(entity);
		...
		protected void onPostExecute(String results) {
			...
			if (results.equals("success")) {
				Toast.makeText(authentification.this, "authentification réussi avec succées",
				...
				Toast.makeText(authentification.this, "authentification échoué",
						Toast.LENGTH_SHORT).show();
			}
			Button b = (Button)findViewById(R.id.button1);
			b.setClickable(true);
