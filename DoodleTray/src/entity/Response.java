...
public class Response implements Serializable {
    ...
    @Id
   @GeneratedValue(strategy = GenerationType.SEQUENCE,generator = "respSequence")
    @SequenceGenerator(name = "respSequence",sequenceName = "Seq_response",initialValue = 1,allocationSize = 1)
    private Long id;
    private int choix;
